...
export const projectsApi = {
  ...
  listInactive: async (): Promise<ProjectListItemDto[]> =>
    (await api.get<ProjectListItemDto[]>('/projects/inactive')).data,
  ...
  deleteWithClient: async (id: string): Promise<void> => {
    await api.delete(`/projects/${id}/with-client`);
  },
