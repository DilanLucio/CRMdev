...
public class ProjectConfiguration : IEntityTypeConfiguration<Project>
{
    public void Configure(EntityTypeBuilder<Project> builder)
    {
        ...
        builder.Property(p => p.Services).HasMaxLength(500);
        builder.Property(p => p.Price).IsRequired().HasColumnType("decimal(18,2)");
        builder.Property(p => p.PricingModel).IsRequired().HasConversion<int>();
        builder.Property(p => p.NextPaymentDate);
        builder.Property(p => p.StartDate).IsRequired();
        builder.Property(p => p.EndDate).IsRequired();
        builder.Property(p => p.DriveLink).HasMaxLength(2048);
        builder.Property(p => p.GitHubRepoUrl).HasMaxLength(2048);
        builder.Property(p => p.HostingProvider).HasMaxLength(100);
        ...
        builder.HasIndex(p => p.NextPaymentDate);
    }
}
