...
public class ProjectRepository : IProjectRepository
{
    ...
    public async Task<IReadOnlyList<Project>> GetAllInactiveAsync(CancellationToken ct = default) =>
        await _db.Projects
            .AsNoTracking()
            .Include(p => p.Client)
            .Include(p => p.Tasks)
    ...
    public void Delete(Project project) => _db.Projects.Remove(project);
